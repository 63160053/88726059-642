...
<body>
    <div class="container">
        <h1> ข้อมูลคำสั่งแต่งตั้ง | <a href='newsdoc.php'><span class='glyphicon glyphicon-plus'></span></a> </h1>
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="ชื่อคำสั่ง" value="">
            <input type="submit">
        </form>
            ...
            $table = "<table class='table table-hover'>
                        <thead>
                            <tr>
                                ...
                                <th scope='col'> วันที่เริ่มคำสั้ง </th>
