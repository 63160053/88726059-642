...
<body>
    <div class="container">
        <h1>ข้อมูลบุคลากร | <a href='newstaff.php'><span class='glyphicon glyphicon-plus'></span></a> </h1>
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="ชื่อบุคลากร" value="">
            <input type="submit">
        </form>
            ...
            $table = "<table class='table table-hover'>
                        <thead>
                            <tr>
                                ...
                                <th scope='col'>แก้ไข้/ลบข้อมูล</th>
                                <th scope='col'></th>
                            </tr>
                        </thead>
                        <tbody>";
